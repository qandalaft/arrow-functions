...
let sum1 = (f, d) => f + d;
let product1 = (f, d) => f * d;
console.log(`${sum1(5, 9)} ${product1(9, 1)}`);
...
let Employee = function (name1, salary, age1) {
    this.name1 = name1;
    this.salary = salary;
    this.age1 = age1;
}

let samer = new Employee('samer', 800, 42);
console.log(samer);
...
// I see we can accsses the constructor values from the object itself 
//and I did it the same by useing the Arrow expression !!!!!! like below  
Employee.prototype.welcome = () => `Hallo ${samer.name1} your salary is ${samer.salary}`;
console.log(Employee.prototype.welcome());
...
// "this" return the all window objects!!!! 
// 3. Explain why "this" is different when an arrow function is used.
// I see the result of console.log of "this" in line '232' is (undefined)!!
// I think when we use the arrow function the result of "this" will be undefined
